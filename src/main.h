...
static const int64 MAX_MONEY = 60000000 * COIN; // coinempz: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 2.5) / 250; // coinempz: Priority cutoff is 2 coinempz day / 250 bytes.
    }
