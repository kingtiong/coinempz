...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "coinempz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nodehosting2245a.net","162.243.185.79"},
    {"cryptolife.net","electrum2.cryptolife.net"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. coinempz is probably already running."), addrBind.ToString().c_str());
        else
